 ...
 * @constructor
 */
function VirtIO9P(cpu, bus, filesystem)
{
...
VirtIO9P.prototype.set_state = function(state)
{
    ...
    this.device && this.device.set_state(state[7]);
    this.device.SendReply = this.device_reply.bind(this);
};
...
VirtIO9P.prototype.handle_descriptor = function(idx)
{
    var next = idx;
...
VirtIO9P.prototype.device_reply = function(queueidx, infos)
{
    if(infos.next === -1)
    {
